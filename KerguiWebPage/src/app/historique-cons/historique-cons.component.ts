...
export class HistoriqueConsComponent {
  historiqueItems = [
    ...
    { nom: 'Micro-onde', emplacement: 'cuisine', duree: '10h', consommation: 20, variation: 0.0025 },
    ...
    { nom: 'Ordinateur', emplacement: 'salon', duree: '8h', consommation: 8, variation: 0.01 },
    ...
    { nom: 'Climatiseur (4)', emplacement: 'salon', duree: '10h', consommation: 15, variation: 0.0375 },
  ];
